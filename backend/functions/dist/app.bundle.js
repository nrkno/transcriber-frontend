...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var docx__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! docx */ \"docx\");\n/* harmony import */ var docx__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(docx__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var firebase_functions__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! firebase-functions */ \"firebase-functions\");\n/* harmony import */ var firebase_functions__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(firebase_functions__WEBPACK_IMPORTED_MODULE_1__);\n/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! lodash */ \"lodash\");\n/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(lodash__WEBPACK_IMPORTED_MODULE_2__);\n/* harmony import */ var serialize_error__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! serialize-error */ \"serialize-error\");\n/* harmony import */ var serialize_error__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(serialize_error__WEBPACK_IMPORTED_MODULE_3__);\n/* harmony import */ var _database__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./database */ \"./src/database.ts\");\n/* harmony import */ var _enums__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./enums */ \"./src/enums.ts\");\n/* harmony import */ var _persistence__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./persistence */ \"./src/persistence.ts\");\n/* harmony import */ var _transcoding__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./transcoding */ \"./src/transcoding.ts\");\n/* harmony import */ var _transcription__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./transcription */ \"./src/transcription.ts\");\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err); } _next(undefined); }); }; }\n\n/**\n * @file Google Cloud function\n * @author Andreas Schjønhaug\n */\n\n\n\n\n\n\n\n\n\nexports.transcription = firebase_functions__WEBPACK_IMPORTED_MODULE_1__[\"region\"](\"europe-west1\").database.ref(\"/transcripts/{id}\").onCreate(\n/*#__PURE__*/\nfunction () {\n  var _ref = _asyncToGenerator(function* (dataSnapshot, eventContext) {\n    const id = dataSnapshot.key;\n\n    try {\n      const transcript = dataSnapshot.val();\n\n      if (transcript === undefined) {\n        throw Error(\"Transcript missing\");\n      }\n\n      const languageCode = transcript.audioFile.languageCode;\n      console.log(`Deployed 13:09 - Start transcription of id ${id} with ${languageCode} `); // First, check if status is \"analysing\", otherwise, cancel\n\n      if (transcript.progress.status !== _enums__WEBPACK_IMPORTED_MODULE_5__[\"Status\"].Analysing) {\n        throw new Error(\"Transcript already processed\");\n      } // 1. Transcode\n\n\n      yield _database__WEBPACK_IMPORTED_MODULE_4__[\"default\"].updateStatus(id, _enums__WEBPACK_IMPORTED_MODULE_5__[\"Status\"].Transcoding);\n      const gcsUri = yield Object(_transcoding__WEBPACK_IMPORTED_MODULE_7__[\"transcode\"])(id); // 2. Transcribe\n\n      yield _database__WEBPACK_IMPORTED_MODULE_4__[\"default\"].updateStatus(id, _enums__WEBPACK_IMPORTED_MODULE_5__[\"Status\"].Transcribing);\n      const speechRecognitionResults = yield Object(_transcription__WEBPACK_IMPORTED_MODULE_8__[\"transcribe\"])(id, gcsUri, languageCode); // 3. Save transcription\n\n      yield _database__WEBPACK_IMPORTED_MODULE_4__[\"default\"].updateStatus(id, _enums__WEBPACK_IMPORTED_MODULE_5__[\"Status\"].Saving);\n      yield Object(_persistence__WEBPACK_IMPORTED_MODULE_6__[\"saveResult\"])(speechRecognitionResults, id); // 4. Done\n\n      yield _database__WEBPACK_IMPORTED_MODULE_4__[\"default\"].updateStatus(id, _enums__WEBPACK_IMPORTED_MODULE_5__[\"Status\"].Success);\n      console.log(\"End transcribing\", id);\n    } catch (error) {\n      console.log(\"Error in main function\");\n      console.error(error);\n      yield _database__WEBPACK_IMPORTED_MODULE_4__[\"default\"].errorOccured(id, error);\n      throw error;\n    }\n  });\n\n  return function (_x, _x2) {\n    return _ref.apply(this, arguments);\n  };\n}());\n/*\nexports.exportToDoc2 = functions.region(\"europe-west1\").https.onCall(async (data, context) => {\n  const doc = new Document()\n\n  console.log(\"export 14:07\")\n\n  const paragraph = new Paragraph(\"Hello World from Cloud functions using onCall yes\")\n\n  doc.addParagraph(paragraph)\n  const packer = new Packer()\n\n  const b64string = await packer.toBase64String(doc)\n\n  if (context.rawRequest.res) {\n    context.rawRequest.res.setHeader(\"Content-Disposition\", \"attachment; filename=My Document.docx\")\n    context.rawRequest.res.send(Buffer.from(b64string, \"base64\"))\n  }\n\n  return context.rawRequest.res\n})\n \nexports.exportToDoc = functions.region(\"europe-west1\").https.onRequest(async (request, response: functions.Response) => {\n  console.log(\"export 14:23\")\n\n  // Set CORS headers for preflight requests\n  // Allows GETs from any origin with the Content-Type header\n  // and caches preflight response for 3600s\n\n  response.set(\"Access-Control-Allow-Origin\", \"*\")\n\n  if (request.method === \"OPTIONS\") {\n    // Send response to OPTIONS requests\n    response.set(\"Access-Control-Allow-Methods\", \"GET\")\n    response.set(\"Access-Control-Allow-Headers\", \"Content-Type\")\n    response.set(\"Access-Control-Max-Age\", \"3600\")\n    response.status(204).send(\"\")\n  } else {\n    try {\n      // Set CORS headers for the main request\n      response.set(\"Access-Control-Allow-Origin\", \"*\")\n      // response.send(\"Hello World! CORS\")\n\n      const doc = new Document()\n\n      const paragraph = new Paragraph(\"Hello World from Cloud functions\")\n\n      doc.addParagraph(paragraph)\n      const packer = new Packer()\n\n      const b64string = await packer.toBase64String(doc)\n      response.setHeader(\"Content-Disposition\", \"attachment; filename=My Document.docx\")\n      response.send(Buffer.from(b64string, \"base64\"))\n    } catch (error) {\n      // Handle the error\n      console.log(error)\n      response.status(500).send(error)\n    }\n  }\n})\n\n*/\n\nexports.exportToDoc = firebase_functions__WEBPACK_IMPORTED_MODULE_1__[\"region\"](\"europe-west1\").https.onRequest(\n/*#__PURE__*/\nfunction () {\n  var _ref2 = _asyncToGenerator(function* (request, response) {\n    try {\n      console.log(\"export 16:16\");\n\n      if (!request.query.id) {\n        throw new Error(\"ID missing\");\n      }\n\n      console.log(request.query.id);\n      const result = yield _database__WEBPACK_IMPORTED_MODULE_4__[\"default\"].downloadText(request.query.id);\n      const text = result.val();\n      const textAsArray = Object(lodash__WEBPACK_IMPORTED_MODULE_2__[\"flatten\"])(Object.keys(text).map(key => text[key])).map(word => word.word);\n      const wordsAsString = textAsArray.join(\" \"); // Export to Word\n\n      const doc = new docx__WEBPACK_IMPORTED_MODULE_0__[\"Document\"]();\n      const paragraph = new docx__WEBPACK_IMPORTED_MODULE_0__[\"Paragraph\"](wordsAsString);\n      doc.addParagraph(paragraph);\n      const packer = new docx__WEBPACK_IMPORTED_MODULE_0__[\"Packer\"]();\n      const b64string = yield packer.toBase64String(doc);\n      response.setHeader(\"Content-Disposition\", \"attachment; filename=My Document.docx\");\n      response.send(Buffer.from(b64string, \"base64\"));\n    } catch (error) {\n      // Handle the error\n      console.log(error);\n      response.status(500).send(serialize_error__WEBPACK_IMPORTED_MODULE_3___default()(error));\n    }\n  });\n\n  return function (_x3, _x4) {\n    return _ref2.apply(this, arguments);\n  };\n}());\nprocess.on(\"unhandledRejection\", (reason, promise) => {\n  console.error(new Error(`Unhandled Rejection at: Promise: ${promise} with reason: ${reason.stack || reason}`));\n});\n\n//# sourceURL=webpack:///./src/index.ts?");
