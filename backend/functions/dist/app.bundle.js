...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _database__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../database */ \"./src/database.ts\");\n/* harmony import */ var _enums__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../enums */ \"./src/enums.ts\");\n/* harmony import */ var _persistence__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./persistence */ \"./src/transcription/persistence.ts\");\n/* harmony import */ var _transcoding__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./transcoding */ \"./src/transcription/transcoding.ts\");\n/* harmony import */ var _transcribe__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./transcribe */ \"./src/transcription/transcribe.ts\");\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err); } _next(undefined); }); }; }\n\n\n\n\n\n\n\nfunction transcription(_x, _x2) {\n  return _transcription.apply(this, arguments);\n}\n\nfunction _transcription() {\n  _transcription = _asyncToGenerator(function* (documentSnapshot, eventContext) {\n    try {\n      console.log(`Deployed 15:53 - Start transcription of id: ${documentSnapshot.id}`);\n      const transcriptId = documentSnapshot.id; // Because of indempotency, we need to fetch the transcript from the server and check if it's already in process\n\n      const step = yield _database__WEBPACK_IMPORTED_MODULE_0__[\"default\"].getStep(transcriptId);\n\n      if (step !== _enums__WEBPACK_IMPORTED_MODULE_1__[\"Step\"].Uploading) {\n        console.warn(\"Transcript already processed, returning\");\n        return;\n      }\n\n      const transcript = documentSnapshot.data();\n\n      if (transcript === undefined || transcript.userId === undefined) {\n        throw Error(\"Transcript or user id missing\");\n      } // 1. Transcode\n\n\n      yield _database__WEBPACK_IMPORTED_MODULE_0__[\"default\"].setStep(transcriptId, _enums__WEBPACK_IMPORTED_MODULE_1__[\"Step\"].Transcoding);\n      const uri = yield Object(_transcoding__WEBPACK_IMPORTED_MODULE_3__[\"transcode\"])(transcriptId, transcript.userId); // 2. Transcribe\n\n      yield _database__WEBPACK_IMPORTED_MODULE_0__[\"default\"].setStep(transcriptId, _enums__WEBPACK_IMPORTED_MODULE_1__[\"Step\"].Transcribing);\n      const speechRecognitionResults = yield Object(_transcribe__WEBPACK_IMPORTED_MODULE_4__[\"transcribe\"])(transcriptId, transcript, uri); // 3. Save transcription\n\n      yield _database__WEBPACK_IMPORTED_MODULE_0__[\"default\"].setStep(transcriptId, _enums__WEBPACK_IMPORTED_MODULE_1__[\"Step\"].Saving);\n      yield Object(_persistence__WEBPACK_IMPORTED_MODULE_2__[\"saveResult\"])(speechRecognitionResults, transcriptId); // 4. Done\n\n      yield _database__WEBPACK_IMPORTED_MODULE_0__[\"default\"].setStep(transcriptId, _enums__WEBPACK_IMPORTED_MODULE_1__[\"Step\"].Done);\n      console.log(\"End transcribing of id: \", transcriptId);\n    } catch (error) {\n      console.log(\"Error in main function\");\n      console.error(error);\n      yield _database__WEBPACK_IMPORTED_MODULE_0__[\"default\"].errorOccured(documentSnapshot.id, error);\n      throw error;\n    }\n  });\n  return _transcription.apply(this, arguments);\n}\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (transcription);\n\n//# sourceURL=webpack:///./src/transcription/index.ts?");
