...
export const credentials = {
  ...
  clientID: functions.config().azure_ad.client_id,
  ...
  redirectUrl: functions.config().azure_ad.redirect_url,
  ...
  clientSecret: functions.config().azure_ad.client_secret,
  ...
  cookieEncryptionKeys: [{ key: "12345678901234567890123456789012", iv: "123456789012" }, { key: "abcdefghijklmnopqrstuvwxyzabcdef", iv: "abcdefghijkl" }],
